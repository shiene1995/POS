...
public class PasswordHashers {
    ...
    public static void main(String[] args) {
        ...
        // Login verification
        String saltFromDB = "ZL7ZaLTf6rBSJEdyFdkT8Q=="; //in the String is salt from DB
        String hashFromDB = "NocrfXc9VPA4jcW26Nv6o1W7497YfcsXkly4u7udYCU="; //in the String is hash from DB
